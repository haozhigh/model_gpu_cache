...
def main():
    ...
    for stride in strides:
        ...
        ax.plot(sub_frame['array_size'] * 8, sub_frame['l1_miss_count'])

        ax.set_title("L1 Cache line size bench")
        ax.set_xlabel("Array Size (Bytes)")
        ax.set_ylabel("L1 Cache Miss Count")
        #ax.set_ylim(0, sub_frame['l1_miss_count'].max() + 5)
        ax.grid()
