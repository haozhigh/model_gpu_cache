...
for suite in $suites; do
    ...
    for bench in $benches; do
        echo "####Generate code traces for: $suite/$bench"
        cd $bench
        ...
        output_dir=../output/trace_code/$suite/$bench
        ...
        duration_output_dir=../output/duration/trace_code/$suite
